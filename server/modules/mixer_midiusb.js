...
if(fs.existsSync('/dev/midi1')) {
    serialPort = new SerialPort('/dev/midi1', {
        baudrate: 38400
    });

    serialPort.on('open', function() {

        console.log('[mixer_midiusb] MIDI/USB port opened');
    ...
    console.log('[mixer_midiusb] ERROR: /dev/midi1 does not exist! Aborting...');
}
